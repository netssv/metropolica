...
export interface DistrictServices { water: UtilityState; electricity: UtilityState; waste: number; safety: number; internet: number; }
export interface DistrictEconomy { employment: number; averageIncome: number; costOfLiving: number; }
...
export interface TileState { col: number; row: number; type: string; level: number; age: number; }
